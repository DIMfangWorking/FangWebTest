...
import Msg
from Msg import ReestablishmentReqMsg
import threading
import pdb
class AtomCheckReestablishment(Atom):
    def __init__(self, item, case):
        ...
        try:
            ...
            print('cfg CheckReestablishment check error')
            return None
        ...
        self.msg = ReestablishmentReqMsg(self.ueGrpId)
        pass
    ...
    def Run(self):
        ...
        self.StopRcv()
        print('Reestablishment check result: ' + str(self.checkResult))
    ...
    def MsgCheck(self, msg,addr = []):
        if self.enbIp != addr[0]:
            ...
            return False
        if msg[0] != Msg.MSG_REESTABLISHMENT_REQUEST_CHECK_RSP:
            return False
